...
// Bitmap font — column-major, 5 columns x 8 rows per glyph.
// Covers ASCII 32 (space) through 126 (~).
// Each byte represents one column; bit 0 = topmost pixel, bit 7 = bottommost.
// Character advance = FONT_CHAR_WIDTH + FONT_CHAR_SPACING.

#define FONT_CHAR_WIDTH   5
#define FONT_CHAR_HEIGHT  8
#define FONT_CHAR_SPACING 1
#define FONT_CHAR_ADVANCE (FONT_CHAR_WIDTH + FONT_CHAR_SPACING)
